...
def split_non_silent_audio(audio_data, sample_width=2, silence_threshold=0.001, sample_rate=16000, chunk_duration=1): # silence_threshold=256, sample_rate=44100
    """
...
async def run(context, input):
    ...
    return streams.Stream.read_from(f"Predicted label: {predictions}\n")
